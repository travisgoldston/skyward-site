  ...
  return (
    <footer className="border-t border-slate-200 bg-white px-5 py-12">
      <div className="mx-auto max-w-6xl">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:gap-16">
            ...
            <div>
              ...
              <a
                ...
                className="text-sm text-slate-500 transition-colors hover:text-green-brand"
              >
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-slate-200 pt-8 sm:flex-row sm:items-center sm:justify-between">
