...
export function HeroSection() {
  return (
    <section aria-label="Hero" className="px-4 pb-4 pt-24 md:px-6 md:pt-28">
      <div className="hero-gradient relative mx-auto max-w-6xl overflow-hidden rounded-3xl px-6 py-14 md:px-10 md:py-16 lg:px-12 lg:py-20">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="relative mt-4 flex items-center justify-center pb-6 lg:mt-0 lg:justify-end lg:pb-0"
          >
            <HeroMockup />
          </motion.div>
        </motion.div>
